...
The required DAY/NIGHT music and CC0 gasp, local breathing, heartbeat and distant siren files are included. The game loads these locally and requires no Freesound account. If a music file
...
Gasp, breathing, heartbeat and siren now use edited CC0 samples; see LICENSES.md.
The door and relay remain procedural and should receive a headphone audition before release.
