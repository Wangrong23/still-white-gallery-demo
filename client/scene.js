...
export class Gallery {
 constructor(canvas){
  ...
  this.sun=new T.DirectionalLight(0xffffff,3.2);this.sun.castShadow=true;this.sun.shadow.mapSize.set(4096,4096);Object.assign(this.sun.shadow.camera,{left:-36,right:36,top:32,bottom:-32,near:0.5,far:130});this.sun.shadow.bias=-0.00055;this.sun.shadow.normalBias=0.055;this.scene.add(this.sun,this.sun.target);this.ambient=new T.AmbientLight(0xffffff,0.48);this.scene.add(this.ambient);
